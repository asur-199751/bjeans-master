  ...
  if (action.type === ADD_TO_CART) {
    const cartItem = cartItems.filter(
      (item) =>
        ...
        product.selectedProductLength === item.selectedProductLength
    )[0]
    ...
    if (cartItem === undefined) {
      ...
      (cartItem.selectedProductColor !== product.selectedProductColor ||
        ...
        cartItem.selectedProductLength !== product.selectedProductLength)
    ) {
      return [
        ...cartItems,
        {
      ...
      return cartItems.map((item) =>
        item.selectedProductId === cartItem.selectedProductId
          ? {
              ...
              selectedProductLength: product.selectedProductLength,
            }
          : item
      )
    }
